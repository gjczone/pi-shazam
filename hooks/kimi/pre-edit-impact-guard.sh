...
# before every WriteFile/StrReplaceFile/Bash operation and auto-blocks (exit 2).
...
#
# stdin: { "hook_event_name": "PreToolUse", "tool_name": "WriteFile|StrReplaceFile|Bash", "tool_input": {...}, "session_id": "..." }
...
# This prevents permanently locking out all edits when MCP is down.
...
# Only block code-changing tools (Kimi tool names)
case "$tool_name" in
