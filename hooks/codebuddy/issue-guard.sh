...
#
# Current pi-shazam tool set (7 tools):
#   shazam_find_tests is NOT available — replaced with Bash `find` for test discovery.
...
# NOTE: shazam_find_tests is not available. Use Bash find for test discovery.
level=0
