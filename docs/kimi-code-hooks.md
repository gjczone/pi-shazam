...
| -------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v0.27.0        | v6（2026-07-06）     | LSP per-file mtime cache invalidation (#641, 修复 dev-loop 假 LSP 错误：编辑源文件后立即 verify 不再需要 touch)；.pi-shazam/config.json (#630, 新增 core/config.ts, shazam_verify maxFiles 迁移到 verify.maxFiles, 移除 dead noCascade/noSecrets 标志, shazam_lookup mode=state 标记为 deprecated)；文档同步 (#645, AGENTS.md / SKILL.md / INSTRUCTION.md)；kimi-code shell hooks 无变更（工具名和 MCP 接口不变）                                                                                                    |
...
| 日期       | 内容                                                                                                                                                                                                              |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-06 | v0.27.0 发布：LSP per-file mtime cache (#641)、.pi-shazam/config.json (#630)、文档同步 (#645)；shazam_lookup mode=state 标记为 deprecated；kimi-code shell hooks 无变更                                           |
